// Author: Do Khanh
// School: UIT
// Description: Layer-1 convolution processing unit for filter 5, sub-branch 1. It receives sliding-window feature data and kernel coefficients, executes INT8 multiply-accumulate cycles with controlled partial-sum updates, and emits branch-local results synchronized to pipeline valid/control timing.

`timescale 1ns / 1ps

module L1_F5_1_process_unit #(
    parameter DATA_WIDTH = 8,
    parameter ADDR_WIDTH = 10,
    parameter CONV_KERNEL_WIDTH = 3,
    parameter CONV_KERNEL_HEIGHT = 3,
    parameter CONV_FM_WIDTH = 28,
    parameter CONV_FM_HEIGHT = 16,
    parameter CONV_RESULT_WIDTH = 26,
    parameter CONV_RESULT_HEIGHT = 14,
    parameter POOL_KERNEL_WIDTH = 2,
    parameter POOL_KERNEL_HEIGHT = 2,
    parameter LAYER_OUTPUT_WIDTH = 13,
    parameter LAYER_OUTPUT_HEIGHT = 7,
	...
	.M0_WIDTH (M0_WIDTH)
	 ...
	 .Z_data_in('d0), .Z_weight_in('d0), .Zo_in('d57), .M0_in('d1662666692),
	 .bias_in('d5254), .n_in('d10),
